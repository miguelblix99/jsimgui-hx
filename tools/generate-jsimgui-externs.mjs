...
async function readSourceFiles() {
	...
	fail('Missing jsimgui declaration files under node_modules/@mori2003/jsimgui/build. Run bun install first.')
}
...
function renderImGuiFile(data) {
	...
	lines.push('**/')
	lines.push('')
	lines.push('extern class ValueStruct {')
	lines.push('}')
	lines.push('')
	lines.push('extern class ReferenceStruct {')
	lines.push('\tvar ptr:Dynamic;')
	lines.push('\t@:native("Drop") function drop():Void;')
	lines.push('}')
	lines.push('')
