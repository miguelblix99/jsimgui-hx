 ...
 */
export class ImColor extends ValueStruct {
    Value;
    constructor(Value) {
        super();
        this.Value = Value;
...
export class ImDrawList extends ReferenceStruct {
    ...
    GetClipRectMin() {
        return this.ptr.ImDrawList_GetClipRectMin();
    }
    GetClipRectMax() {
        return this.ptr.ImDrawList_GetClipRectMax();
    }
    /**
     * Primitives
    ...
    AddImage(
        ...
        p_min,
        p_max,
        uv_min = new ImVec2(0, 0),
        uv_max = new ImVec2(1, 1),
        col = IM_COL32_WHITE,
    ) {
     ...
     */
    CloneOutput() {
        return this.ptr.ImDrawList_CloneOutput();
    }
    /**
     * Advanced: Channels
...
export class ImFontConfig extends ReferenceStruct {
    ...
    // nsigned int  FontBuilderFlags;       \/\/ --       \/\/ [Renamed in 1.92] Ue FontLoaderFlags.
    /**
...
export class ImFontAtlas extends ReferenceStruct {
     ...
     */
    get TexDesiredFormat() {
        return this.ptr.get_TexDesiredFormat();
    }
    set TexDesiredFormat(v) {
        this.ptr.set_TexDesiredFormat(v);
    }
    /**
    ...
    AddFont(font_cfg) {
        return this.ptr.ImFontAtlas_AddFont(font_cfg?.ptr ?? null);
    }
    AddFontDefault(font_cfg = null) {
        return this.ptr.ImFontAtlas_AddFontDefault(font_cfg?.ptr ?? null);
    }
...
export class ImGuiViewport extends ReferenceStruct {
     ...
     */
    GetCenter() {
        return this.ptr.ImGuiViewport_GetCenter();
    }
    GetWorkCenter() {
        return this.ptr.ImGuiViewport_GetWorkCenter();
    }
}
/**
 ...
 */
const loadTextureWebGL = (data, options = {}) => {
 ...
 * @returns The ImTextureID of the loaded texture.
 */
const loadTextureWebGPU = (data, options = {}) => {
